...
interface MomentService {
     ...
     */
    @POST("api/moments")
    fun createMoment(@Body moment: Moment): Call<Result<Moment>>
     ...
     */
    @GET("api/moments/{id}")
    fun getMomentById(@Path("id") id: String): Call<Result<Moment>>
    ...
    fun getMomentsByIds(@Body ids: List<String>): Call<Result<List<Moment>>>
    ...
    fun deleteMoment(@Path("id") id: String): Call<Result<Void>>
    ...
    fun searchMoments(@Query("keyword") keyword: String): Call<Result<List<Moment>>>
